...
const showroomData = {
  ...
  address:
    "No. 22b, Sunny Bus Stop, Olojo Drive, Alaba International Market, Ojo, Lagos, Nigeria",
  ...
  mapUrl:
    "https://maps.google.com/?q=No.+22b,+Sunny+Bus+Stop,+Olojo+Drive,+Alaba+International+Market,+Ojo,+Lagos,+Nigeria",
  features: [
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
                Step into our spacious showroom and discover the perfect
                furniture for your home or office. Our knowledgeable staff is
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href={`mailto:${showroomData.email}`}
                      className="text-blue-600 hover:underline"
                    >
                      {showroomData.email}
                    </a>
