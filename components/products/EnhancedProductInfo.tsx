        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
          ...
          <div className="flex flex-col sm:flex-row gap-2 flex-1 w-full sm:w-auto">
            <Button
              ...
              className="h-10 flex-1 bg-blue-600 hover:bg-blue-700 text-white shadow-sm rounded-lg font-medium text-base transition-all duration-200 hover:scale-[1.02]"
            >
            ...
            <Button
              ...
              className="h-10 flex-1 bg-green-600 hover:bg-green-700 text-white shadow-sm rounded-lg font-medium text-base transition-all duration-200 hover:scale-[1.02]"
            >
