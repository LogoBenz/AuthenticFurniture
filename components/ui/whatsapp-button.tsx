...
export function FloatingWhatsAppButton() {
  const handleWhatsAppClick = () => {
    ...
    const phoneNumber = "23490377725829"; // Updated to correct number
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg transition-colors group"
