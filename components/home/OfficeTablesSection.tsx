          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed max-w-3xl">
                Boost productivity at work or school with our premium office tables. Designed for comfort, durability, and style, our collection features ergonomic designs perfect for any modern workspace.
              </p>
            </div>
            <Link
